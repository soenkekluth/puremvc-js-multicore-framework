 ...
 */var Model=function(){function Model(key){_classCallCheck(this,Model);if(Model.instanceMap[key]){throw new Error(Model.MULTITON_MSG)}/**
   ...
   */Model.prototype.removeProxy=function removeProxy(proxyName){var proxy=this.proxyMap[proxyName];if(proxy){this.proxyMap[proxyName]=null;proxy.onRemove()}return proxy};/**
   * @static
