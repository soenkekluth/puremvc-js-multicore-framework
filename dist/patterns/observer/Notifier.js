 ...
 */var Notifier=function(){function Notifier(){_classCallCheck(this,Notifier);/**
   ...
   * @return {void}
   */Notifier.prototype.initializeNotifier=function initializeNotifier(key){this.multitonKey=String(key);this.facade=this.getFacade()};/**
   * Retrieve the Multiton Facade instance
   *
   *
   * @protected
   * @return {puremvc.Facade}
   */Notifier.prototype.getFacade=function getFacade(){if(!this.multitonKey){throw new Error(Notifier.MULTITON_MSG)}return Facade.getInstance(this.multitonKey)};/**
   * @ignore
